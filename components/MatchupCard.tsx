...
export function MatchupCard({
  ...
  return (
    <button
      ...
      className={[
        "group relative flex h-full w-full min-w-0 max-w-md cursor-pointer select-none flex-col items-stretch overflow-hidden rounded-2xl border border-black/[0.04] bg-white px-0 py-4 text-left shadow-[0_18px_60px_rgba(15,23,42,0.06)] outline-none transition-all duration-200 lg:rounded-3xl lg:py-6",
    ...
    >
      <CompanyProfileCard
        company={company}
        footer={
          <span className="mt-4 flex h-5 w-full items-center justify-center text-xs font-bold text-black lg:mt-6 lg:h-6 lg:text-sm">
